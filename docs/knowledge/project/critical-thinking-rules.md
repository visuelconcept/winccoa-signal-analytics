...
- Before proposing a solution, check the relevant context files in `.ai/` and any linked documentation. If a workflow or architecture is already documented, follow it.
...
- Unless explicitly asked otherwise, be extremely concise. Sacrifice grammar for the sake of concision.
- Skip affirmations like "Great idea", "Absolutely", "That's a smart approach", "You're right". Lead with substance.
